...
export default function Sidebar({ filters, setFilters }) {
  ...
  const districtsData = {
    ...
    "Nagaland": ["Chumoukedima", "Dimapur", "Kohima", "Longleng", "Mokokchung", "Mon", "Noklak", "Peren", "Phek", "Shamator", "Tuensang", "Tseminyu", "Wokha", "Zunheboto"],
    ...
    "Jammu and Kashmir": ["Anantnag", "Bandipora", "Baramulla", "Budgam", "Doda", "Ganderbal", "Jammu", "Kathua", "Kishtwar", "Kupwara", "Poonch", "Pulwama", "Rajouri", "Ramban", "Reasi", "Samba", "Shopian", "Srinagar", "Udhampur"],
    "Ladakh": ["Kargil", "Leh"],
    "Lakshadweep": ["Agatti", "Amini", "Androth", "Bithra", "Chethlath", "Kavaratti", "Kadmat", "Kalpeni", "Kilton", "Minicoy"],
  ...
  const [csvStatus, setCsvStatus] = useState(""); // ✅ CSV status

  useEffect(() => {
    if (filters.state && districtsData[filters.state]) {
      setDistricts(districtsData[filters.state]);
      handle("district", ""); // reset district when state changes
    } else {
      setDistricts([]);
      handle("district", "");
    }
  ...
  const handleCSVUpload = async (file) => {
    ...
    if (result.success) {
      handle("csv", file); // store file in filters if needed
    }
  };
